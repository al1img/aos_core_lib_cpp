...
{
    for (const auto& uintInstanceStatus : unitInstancesStatuses) {
        for (const auto& instanceStatus : uintInstanceStatus.mInstances) {
            InstanceStatus status;

            status.mItemID         = uintInstanceStatus.mItemID;
            status.mSubjectID      = uintInstanceStatus.mSubjectID;
            status.mVersion        = uintInstanceStatus.mVersion;
