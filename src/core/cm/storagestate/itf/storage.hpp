...
public:
     ...
     * @return Error.
     */
    virtual Error RemoveStorageStateInfo(const InstanceInfo& instanceIdent) = 0;
     ...
     * @return Error.
     */
    virtual Error GetStorageStateInfo(const InstanceInfo& instanceIdent, InstanceInfo& info) = 0;
     ...
     * @return Error.
     */
    virtual Error UpdateStorageStateInfo(const StorageStateInstanceInfo& info) = 0;
